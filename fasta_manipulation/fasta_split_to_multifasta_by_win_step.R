...
library(phylotools)
# input parameters
parser <- ArgumentParser(description='split a single-fasta file using a sliding window approach and export the sequences in a multi-fasta file')
...
# export to fasta
dat2fasta(splitted_fasta,outfile = args$out)
