...
df2$start <- starts - seq_length
df2$end <- nchar(as.character(df2$sapply.starts..function.i...)) + starts -1 - seq_length
# combine results and calculate the Obs/Exp ratio and %GC content
df <-rbind(df1,df2)
