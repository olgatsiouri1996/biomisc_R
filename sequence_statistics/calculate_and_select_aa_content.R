...
parser$add_argument('--min', help= 'min aa content cutoff to export')
parser$add_argument('--max', help= 'max aa content cutoff to export')
...
colnames(gc_table) <- c("fasta_header","%aa")
