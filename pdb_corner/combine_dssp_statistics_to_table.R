...
parser$add_argument('--txtdir', help= 'absolute path to the directory of input txt files(with pdb ids as part of their names and suffix: "_stats.txt") created with: https://github.com/olgatsiouri1996/biomisc/blob/main/pdb_corner/pdb_secondary_structure_statistics.py or https://github.com/olgatsiouri1996/biomisc/blob/main/pdb_corner/dssp_statistics_by_chain.py)')
